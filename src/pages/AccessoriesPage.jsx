...
function AccessoriesPage() {
  ...
  const generateCategorySchema = () => ({
    ...
    "@type": "ItemList",
    "name": "Accessories Collection - MyPinkShop",
    "description": "Shop stunning accessories including jewelry, bags, sunglasses, watches, and more to complete your look.",
  ...
  const generateBreadcrumbSchema = () => ({
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Accessories", "item": "https://www.mypinkshop.com/accessories" }
    ]
  });
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <p className="text-sm">Luxury accessories and fashion for the modern woman.</p>
              </div>
              <div>
