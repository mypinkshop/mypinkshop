...
const accessoriesCategories = [
  ...
  { id: 'bags', name: 'Bags & Purses', icon: '👜' },
  { id: 'sunglasses', name: 'Sunglasses', icon: '🕶️' },
  { id: 'watches', name: 'Watches', icon: '⌚' },
  { id: 'hairAccessories', name: 'Hair Accessories', icon: '🎀' },
  { id: 'scarves', name: 'Scarves & Stoles', icon: '🧣' },
  { id: 'belts', name: 'Belts', icon: '⛓️' },
...
function AccessoriesPage() {
  ...
  useEffect(() => {
    ...
    const accessoriesProducts = storedProducts.filter(p => 
  ...
  }, [searchTerm, selectedSubcat, minPrice, maxPrice, sortBy, products]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm border-b border-pink-100">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex-1 max-w-md"><input type="text" placeholder="Search accessories..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full px-5 py-2.5 border rounded-full bg-gray-50 text-sm" /></div>
      ...
      <div className="bg-gradient-to-r from-amber-100 to-yellow-100 py-12 text-center">
        <h1 className="text-4xl font-bold text-amber-800 mb-2">Accessories 💍</h1>
        <p className="text-amber-600">Complete your look with our stunning accessories</p>
      </div>
