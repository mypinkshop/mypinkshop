...
// OPTIMIZED Product Card Component with caching and image optimization
...
function AccessoriesPage() {
      ...
      try {
        ...
        if (cached && cacheTime && (Date.now() - parseInt(cacheTime)) < 60000) {
          ...
          const accessoriesProducts = productsArray.filter(p => 
            ...
            p.status === 'active'
          ).map(p => ({ ...p, id: p._id, subcategory: p.subCategory || p.subcategory || p.category }));
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [products, searchTerm, selectedCategory, selectedSubcategory, selectedBrand, sortBy, priceRange]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50">
        ...
        <div className="relative bg-gradient-to-r from-pink-100 via-rose-100 to-pink-100">
          <div className="max-w-7xl mx-auto px-4 py-12 text-center">
            ...
            <p className="text-gray-600 text-sm">Complete your look with our stunning accessories</p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 pb-12">
          ...
          {filteredProducts.length === 0 ? (
            <div className="bg-white/80 rounded-2xl p-12 text-center border border-pink-100">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-1">No accessories found</h3>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
              <div>
                ...
                <p className="text-xs">Luxury accessories for the modern woman.</p>
              </div>
              <div>
