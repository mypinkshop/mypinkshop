...
function ClothingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-blue-100 via-indigo-100 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-700 to-purple-700 bg-clip-text text-transparent mb-4">
            Clothing Collection 👗
          </h1>
