...
function FAQs() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'You can track your order from "My Orders" section in your account. A tracking link is also sent to your email and SMS once the order is shipped.',
      category: 'orders',
      helpful: 189,
    },
    {
    ...
    // Account
    {
      ...
      answer: 'Click on the "Sign Up" button on the top right, fill in your details, verify your email with OTP, and you\'re ready to shop!',
      category: 'account',
      helpful: 98,
    },
    {
  ...
  const generateBreadcrumbSchema = () => ({
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "FAQs", "item": "https://www.mypinkshop.com/faqs" }
    ]
  });
  ...
  return (
    <>
      <Helmet>
        <title>Frequently Asked Questions - MyPinkShop | Help Center</title>
        <meta name="description" content="Find answers to common questions about orders, shipping, returns, payments, and account management at MyPinkShop. 24/7 customer support available." />
        <meta name="keywords" content="faqs, help center, customer support, order help, shipping help, return policy, mypinkshop help" />
        <link rel="canonical" href="https://www.mypinkshop.com/faqs" />
        <meta property="og:title" content="FAQs - MyPinkShop Help Center" />
        <meta property="og:description" content="Find answers to your questions about orders, shipping, returns, and more." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.mypinkshop.com/faqs" />
        <meta property="og:image" content="https://www.mypinkshop.com/og-faqs.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="FAQs - MyPinkShop Help Center" />
        <meta name="twitter:description" content="Find answers to your questions quickly." />
        <meta name="twitter:image" content="https://www.mypinkshop.com/og-faqs.jpg" />
                  ...
                  {openFaq === faq.id && (
                    <div className="px-6 pb-5 pt-2 border-t border-pink-100 bg-pink-50/30">
                      ...
                      <div className="flex gap-3 mt-4">
                        ...
                        <Link to="/contact" className="text-xs text-pink-500 hover:text-pink-600 flex items-center gap-1">
                          📞 Contact Support
                        </Link>
                      </div>
                    </div>
