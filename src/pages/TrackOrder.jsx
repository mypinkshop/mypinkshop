...
function TrackOrder() {
  ...
  const generateBreadcrumbSchema = () => ({
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Track Order", "item": "https://www.mypinkshop.com/track-order" }
    ]
  });
  ...
  if (!order) {
    return (
      <>
        <Helmet>
          <title>Track Order - MyPinkShop | Order Not Found</title>
          <meta name="description" content="Track your MyPinkShop order status. Enter your order ID to get real-time updates on delivery." />
          <meta name="keywords" content="track order, order status, delivery tracking, mypinkshop tracking" />
          <link rel="canonical" href="https://www.mypinkshop.com/track-order" />
          <meta property="og:title" content="Track Order - MyPinkShop" />
          <meta property="og:description" content="Track your order status in real-time." />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://www.mypinkshop.com/track-order" />
          <meta property="og:image" content="https://www.mypinkshop.com/og-track.jpg" />
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content="Track Order - MyPinkShop" />
          <meta name="twitter:description" content="Track your order status." />
          <meta name="twitter:image" content="https://www.mypinkshop.com/og-track.jpg" />
  ...
  return (
    <>
      <Helmet>
        <title>Track Order #{order._id?.slice(-8)} - MyPinkShop</title>
        <meta name="description" content={`Track your order #${order._id?.slice(-8)} status. Current status: ${getStatusText(order.status)}. Estimated delivery updates available.`} />
        <meta name="keywords" content="track order, order status, delivery tracking, mypinkshop tracking" />
        <link rel="canonical" href={`https://www.mypinkshop.com/track-order/${orderId}`} />
        <meta property="og:title" content={`Track Order #${order._id?.slice(-8)} - MyPinkShop`} />
        <meta property="og:description" content={`Order status: ${getStatusText(order.status)}. Track your delivery in real-time.`} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`https://www.mypinkshop.com/track-order/${orderId}`} />
        <meta property="og:image" content="https://www.mypinkshop.com/og-track.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Track Order #${order._id?.slice(-8)}`} />
        <meta name="twitter:description" content={`Order status: ${getStatusText(order.status)}`} />
        <meta name="twitter:image" content="https://www.mypinkshop.com/og-track.jpg" />
        <script type="application/ld+json">{JSON.stringify(generateBreadcrumbSchema())}</script>
        <script type="application/ld+json">{JSON.stringify(generateOrganizationSchema())}</script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-16">
          ...
          {/* Order Status Card */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-pink-100 p-4 sm:p-6 mb-6 shadow-sm">
