    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold text-gray-800">Shipping Zones & Rates</h1>
        </div>
      </div>

      <div className="p-6">
        <div className="flex justify-end mb-4">
          <button className="bg-pink-600 text-white px-4 py-2 rounded-lg text-sm">+ Add Shipping Zone</button>
        </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left">Regions / Cities</th>
                  <th className="px-4 py-3 text-right">Shipping Rate</th>
                  <th className="px-4 py-3 text-right">Free Shipping Above</th>
        ...
        <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-sm text-yellow-800">💡 Tip: Free shipping applies when order total exceeds the threshold. Default shipping rate applies for orders below threshold.</p>
        </div>
      </div>
    </div>
  );
