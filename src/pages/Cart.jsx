              ...
              {cart.map((item) => (
                <div key={item.id} className="group grid grid-cols-1 md:grid-cols-12 gap-4 items-center px-4 md:px-6 py-5 border-b border-pink-100 hover:bg-pink-50/30 transition">
                  ...
                  <div className="md:col-span-6 flex gap-4">
                    <div className="w-16 h-16 bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl flex items-center justify-center text-3xl shadow-sm">
                      {item.emoji || '✨'}
                    </div>
                    <div>
                  ...
                  <div className="md:col-span-2 text-center">
                    ...
                    <span className="font-bold text-pink-500 text-lg">₹{item.price * item.quantity}</span>
                  </div>
                </div>
              ))}
            </div>
